      ...
      <div className="space-y-2">
        <div className="flex justify-between">
          ...
          <Input
            ...
            className="w-24 text-right font-hanuman bg-[rgba(255,255,255,0.05)] focus:bg-[rgba(255,255,255,0.1)] border border-[#56585e]/50 border-[0.5px] focus:border-0 cursor-text focus:outline-none focus:ring-0 focus:ring-offset-0"
          />
        </div>
        <Slider
          value={[brokersFee]}
